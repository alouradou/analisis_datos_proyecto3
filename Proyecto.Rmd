...
```
### Evaluación de diferentes Random Forests
...
Vemos en Results.txt que el modelo con la MSE la más baja es el 500, 200, 3 
que vamos a usar ahora.


### Seleción del mejor RF (500, 200, 3)

```{r}
modelo1 = randomForest(train_datos[,-19],train_datos[,19],ntree=500,maxnodes=200, mtry=3, importance=TRUE)
